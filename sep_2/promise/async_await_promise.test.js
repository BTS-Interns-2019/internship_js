...
describe('manipulations with promises', () => {
  ...
  test('create a post', () => {
    ...
    return get('/users/self').then( userInfo => {
  ...
  test('like a post', () => {
    ...
    return get('/users/self').then( (response) => {
      ...
      return post('/posts', msg).then( (response) => {
        const postBody = JSON.parse(response);
        ...
        return request('PUT', `/posts/${postID}/like`, requestBody).then( (response) => {
