...
function kSum(strNum1, strNum2) {
  ...
  // Remainder to keep track of the remainder if the sum of the digits is bigger than 9
  let remainder = 0;
  // Variable to sum the digits of both strings
  let digitSum;

  // Stops at 1, to not mess with the last digit of both strings
  for (let i = (strNum1.length - 1); i >= 1; i -= 1) {
    ...
    // If the digitSum is bigger than 9 (has more than one digit), 
    // assign remainder to remainder variable
