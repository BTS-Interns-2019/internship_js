 ...
 * Retorna true si hay conflicto y false si no lo hay
 ...
 */
has_conflict = function (columns, xy) {
...
/**
 * Recibe el tamaño del tablero, las reinas que faltan por colocar y la coordenada donde debe haber una reina.
 * Prueba las combinaciones posibles hasta encontrar una correcta o descartar todas
 * Retorna un arreglo con las posiciones correctas de las reinas
 * @param {number} size     tamaño del tablero
 ...
 */
place_next_queen = function (size, queens, xy, columns) {
